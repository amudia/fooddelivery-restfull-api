...
const detail = 'SELECT riviews.id_item, riviews.id_riview, users.name, users.id_user, riviews.riview, riviews.rating FROM riviews INNER JOIN users ON users.id_user=riviews.id_user WHERE riviews.id_item=?'
